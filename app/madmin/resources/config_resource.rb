class ConfigResource < Madmin::Resource
  ...
  attribute :purchase_notifications_enabled, label: "Enable purchase notification emails", description: "Send email notifications to admins when purchases are made"
